# JSweet codemirror candy

## Description

This project is a Java bridge to the codemirror library, so that codemirror can be used from Java (thanks to the JSweet transpiler).
